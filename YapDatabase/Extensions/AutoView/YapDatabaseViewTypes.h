...
typedef NSComparisonResult (^YapDatabaseViewSortingWithObjectBlock)
                 (YapDatabaseReadTransaction *transaction, NSString *group,
                      NSString *collection1, NSString *key1, __nullable id object1,
                      NSString *collection2, NSString *key2, __nullable id object2);
...
typedef NSComparisonResult (^YapDatabaseViewSortingWithRowBlock)
                 (YapDatabaseReadTransaction *transaction, NSString *group,
                      NSString *collection1, NSString *key1, __nullable id object1, _Nullable id metadata1,
                      NSString *collection2, NSString *key2, __nullable id object2, _Nullable id metadata2);
